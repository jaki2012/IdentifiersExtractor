...
#define MAX 50
/*  */
static double p[6]={4,-6,3,1,-1,5};	/* 4x^5 - 6x^4 + 3x^3 + x^2 - x + 5 */
static double q[4]={3,2,-5,1};		/* 3x^3 + 2x^2 - 5x + 1 */
static double result[9]={0,0,0,0,0,0,0,0,0};		/* */
