...
class CPP14Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "MultiLineMacro", "Directive", "Alignas", 
                      ...
                      "Else", "Enum", "Explicit", "Export", "Extern", "FFalse", 
                      ...
                      "Thread_local", "Throw", "TTrue", "Try", "Typedef", 
    ...
    def primaryexpression(self):
        ...
        try:
            ...
            if token in [CPP14Parser.FFalse, CPP14Parser.Nullptr, CPP14Parser.TTrue, CPP14Parser.Integerliteral, CPP14Parser.Characterliteral, CPP14Parser.Floatingliteral, CPP14Parser.Stringliteral, CPP14Parser.Userdefinedintegerliteral, CPP14Parser.Userdefinedfloatingliteral, CPP14Parser.Userdefinedstringliteral, CPP14Parser.Userdefinedcharacterliteral]:
                self.enterOuterAlt(localctx, 1)
                self.state = 403
                self.literal()
                pass
    ...
    def literal(self):
        ...
        try:
            ...
            if token in [CPP14Parser.Integerliteral]:
                ...
                self.match(CPP14Parser.Stringliteral)
                pass
            elif token in [CPP14Parser.FFalse, CPP14Parser.TTrue]:
                self.enterOuterAlt(localctx, 5)
                self.state = 2456
                self.booleanliteral()
                pass
    ...
    class BooleanliteralContext(ParserRuleContext):
        ...
        def FFalse(self):
            return self.getToken(CPP14Parser.FFalse, 0)

        def TTrue(self):
            return self.getToken(CPP14Parser.TTrue, 0)
    ...
    def booleanliteral(self):
        ...
        try:
            ...
            self.state = 2461
            _la = self._input.LA(1)
            if not(_la==CPP14Parser.FFalse or _la==CPP14Parser.TTrue):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
