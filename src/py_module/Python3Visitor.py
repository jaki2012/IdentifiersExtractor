# Generated from Z:/IdentifiersExtractor/IdentifiersExtractor/src/py_module\Python3.g4 by ANTLR 4.7
import re
from antlr4 import *
...
class Python3Visitor(ParseTreeVisitor):
    ...
    def visitImport_as_name(self, ctx:Python3Parser.Import_as_nameContext):
        if ctx.getText() is not None and len(ctx.children) == 1:
            if not ctx.getText().isdigit():
